$(function () {
  ...
  $('input#name, input#surname, input#email').unbind().blur(function () {
    ...
    switch (id) {
      ...
      case 'name':
        ...
        if (val.length > 2 && val != '' && rv_name.test(val)) {
          ...
          $(this).nextAll('.form-group__error').text('Прийнято')
            .css('color', '#0286c2')
            .animate({
              'paddingLeft': '10px'
            }, 400)
        ...
        // и ниже в наш контейнер выводим сообщение об ошибке и параметры для верной валидации
          ...
          $(this).nextAll('.form-group__error').text("Введіть, будь ласка ваше ім'я")
            .css('color', 'red')
            .animate({
              'paddingLeft': '10px'
            }, 400)
      ...
      case 'surname':
        ...
        // и ниже в наш контейнер выводим сообщение об ошибке и параметры для верной валидации
          ...
          $(this).removeClass('not_error').addClass('error');
          $(this).nextAll('.form-group__error').text('Введіть, будь ласка, ваше прізвище')
            .css('color', 'red')
            .animate({
              'paddingLeft': '10px'
            }, 400)
      ...
      case 'email':
        ...
        if (val != '' && rv_email.test(val)) {
          ...
          $(this).removeClass('not_error').addClass('error');
          $(this).nextAll('.form-group__error').text('Введіть, будь ласка, ваш e-mail')
            .css('color', 'red')
            .animate({
              'paddingLeft': '10px'
            }, 400)
    ...
    if ($('.not_error').length == 3) {
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          $('.form form :text').val('').removeClass().next('.form-group__error').text('');
          alert(response);
        }
      }); // end ajax({...})
    }
